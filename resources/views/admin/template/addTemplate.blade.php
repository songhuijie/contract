            ...
            <form class="layui-form" >
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="title" required  lay-verify="required"  placeholder="请输入模板名称" autocomplete="off" class="layui-input" value="@if(!empty($template)){{$template->title}}@endif">
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="sort" required  lay-verify="required"  placeholder="请输入排序" autocomplete="off" class="layui-input" value="@if(!empty($template)){{$template->sort}}@endif">
                    </div>
                </div>
                ...
                <div class="layui-form-item layui-form-text">
                    ...
                    <div class="layui-input-block">
                        <textarea name="content" id="qaContent" lay-verify="content">@if(!empty($template)){{$template->content}} @endif</textarea>
                    </div>
                </div>

                @if(!empty($template))
                    <input type="text" id="mold" hidden  value="edit" >
                    <input type="text" id="id" hidden value="{{$template->id}}" >
                @endif
