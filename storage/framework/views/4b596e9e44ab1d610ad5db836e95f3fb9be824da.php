            ...
            form.on('submit(formDemo)', function(data){
                ...
                if($("#mold").val()!=undefined){
                    ...
                    $.ajax({
                        ...
                        type:"post",
                        datatype:"json",
                        url:"<?php echo e(url('admin/certification')); ?>",
                        success:function(res){
                            console.log(res);
                            if(res.code==0){
                                parent.layer.msg(res.msg);
...
<?php echo $__env->make("admin.layout.modify", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\phpstudy_pro\WWW\contract\resources\views/admin/certification/addCertification.blade.php ENDPATH**/ ?>