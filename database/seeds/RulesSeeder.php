...
class RulesSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('rules')->insert([
            ['title' => '权限', 'href' => null, 'rule' => null, 'pid' => 0, 'check' => 1, 'status' => 1, 'level' => 1, 'icon' => '&#xe614;', 'sort' => 10],
            ...
            ['title' => '修改密码', 'href' => '', 'rule' => '', 'pid' => 0, 'check' => 0, 'status' => 0, 'level' => 1, 'icon' => 'img/home.png', 'sort' => 1],
            ['title' => '首页', 'href' => '/admin/user/password/edit', 'rule' => 'indexcontroller@editpassword', 'pid' => 0, 'check' => 0, 'status' => 1, 'level' => 1, 'icon' => null, 'sort' => 0],
